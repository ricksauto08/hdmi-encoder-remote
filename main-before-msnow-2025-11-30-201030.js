...
// ----------------- Generic helper (FAST+PLAY, iframe-friendly) -----------------
// Make sure at least one <video> is actually playing when we can see it.
// If we click a play button but never see <video>, assume it's hidden in an iframe
// (like some NBC/ABC/MS sites) and don't hang forever.
